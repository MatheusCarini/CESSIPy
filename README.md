...
CESSIPy is a Python module for estimating a modal model of a vibrating structure from output-only measurements. The identified model consists of natural frequencies, damping ratios and modal shapes and the inputs are assumed to be realizations of a white noise process. 
