...
Excitation: human walking and jumping
...
# Only third signal (vertical acceleration) is analysed.
# First 2000 values and last values are discarded because the operator was
# touching the smartphone instead of measuring the slab vibration.

h1 = yk.plot_time(unit=' (m/s²)')    # plot time series
# -----------------------------------------------------------------------------
...
# BFD interactive: remove quotation marks to use this mode
'''
...
# EFDD interactive: remove quotation marks to use this mode
'''
